...
**дополнительно создан NLB для доступа к воркенодам снаружи**

для NLB зарезервирован адрес `51.250.77.76` и к нему привязан домен `www.knit.tale.ru`
...
Name:             nginx-app-depl-68c967d755-84gsl
Namespace:        default
Priority:         0
Service Account:  default
Node:             worker-node-2/192.168.20.32
Start Time:       Wed, 10 Dec 2025 19:27:05 +0000
Labels:           app=nginx-app
                  pod-template-hash=68c967d755
Annotations:      cni.projectcalico.org/containerID: 8cd6f83d1496d9eb695ed4dfa4d113d1552fa3ad4b582026865c4bf04e464491
                  cni.projectcalico.org/podIP: 10.233.83.180/32
                  cni.projectcalico.org/podIPs: 10.233.83.180/32
Status:           Running
IP:               10.233.83.180
IPs:
  IP:           10.233.83.180
Controlled By:  ReplicaSet/nginx-app-depl-68c967d755
Containers:
  nginx-app-c:
    Container ID:   containerd://0e62faf99ab53f1ea665582002c8fb1f5cb5663c2918edd8eff28d6384643bb8
    Image:          cr.yandex/crpefno6d2dqdrf96gqk/nginx-app:v0.1.1
    Image ID:       cr.yandex/crpefno6d2dqdrf96gqk/nginx-app@sha256:9ca0b0e0349e51a468fe46565b75681f0ff54b2ae4915a2b916bffd166abd629
    Port:           80/TCP
    Host Port:      0/TCP
    State:          Running
      Started:      Wed, 10 Dec 2025 19:27:06 +0000
    Ready:          True
    Restart Count:  0
    Liveness:       http-get http://:80/healthz delay=5s timeout=1s period=10s #success=1 #failure=3
    Environment:    <none>
    Mounts:
      /var/run/secrets/kubernetes.io/serviceaccount from kube-api-access-fm7mn (ro)
Conditions:
  Type                        Status
...
Events:
  ...
  ----    ------     ----  ----               -------
  Normal  Scheduled  10m   default-scheduler  Successfully assigned default/nginx-app-depl-68c967d755-84gsl to worker-node-2
  Normal  Pulling    10m   kubelet            Pulling image "cr.yandex/crpefno6d2dqdrf96gqk/nginx-app:v0.1.1"
  Normal  Pulled     10m   kubelet            Successfully pulled image "cr.yandex/crpefno6d2dqdrf96gqk/nginx-app:v0.1.1" in 700ms (700ms including waiting). Image size: 22998604 bytes.
  Normal  Created    10m   kubelet            Created container: nginx-app-c
  Normal  Started    10m   kubelet            Started container nginx-app-c
```
...
был выбран пакет Kubespray v2.29.0 - описание комманд в **#### РЕШЕНИЕ 3**
