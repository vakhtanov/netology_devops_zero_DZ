...
3. вы выполнили домашнее задание [«L3-сеть».](https://github.com/netology-code/snet-homeworks/blob/snet-22/4-03.md)

[Полезные комнады Cisco](https://achromesite.wordpress.com/2017/01/10/useful-commands-a-cisco-to-view-info/)
...
5. В Cisco Packet Tracer запустите режим симуляции и начните из командной строки с любого ПК главного офиса процесс подключения по telnet к маршрутизатору.
6. В режиме симуляции найдите момент, когда процесс трёхстороннего рукопожатия между ПК и маршрутизатором окончен и TCP-соединение установлено.
7. В командной строке выбранного ПК выполните вход на маршрутизатор с помощью ранее указанного пароля.
8. Посмотрите на маршрутизаторе все TCP-соединения. Сделайте скриншот.
9. Продолжая работать в режиме симуляции, завершите в командной строке сеанс telnet на ПК. Укажите момент, когда процесс TCP-соединения между ПК и маршрутизатором окончен.
10. Ответы внесите в комментарии к решению задания в личном кабинете.

[схема сети](dz4_task1.pkt)

соединение с маршрутизатором\
![tcp_connections.JPG](tcp_connections.JPG)

TCP соединения\
![all_tcp_conn.JPG](all_tcp_conn.JPG)

завершение соединения\
![end_connection.JPG](end_connection.JPG)
