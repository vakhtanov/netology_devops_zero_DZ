...
![пакет](1dz1.PNG)
* Физический уровень - передано 183 байта попроводам
* Канальный уровень - протокол Ethernet II, фрейм 60604
...
У DNS и HTTP различается:
- траспортный уровень, у DNS - UPD - без контроля доставки и целостности, у HTTP - TCP - с контролем
- Прикладной уровень - на нем собственно целевые протоколы
