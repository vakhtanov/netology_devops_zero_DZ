...
PV автоматически не создается.
pod и pvc зависают в состоянии pending.

похоже не до конца разобрался в механизме StorageClass, подскажите в какую сторону смотреть.
