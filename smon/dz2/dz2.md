...
![task1](https://github.com/user-attachments/assets/f4c5e965-95b2-4191-b253-a242ecd828a6)
...
![task2](https://github.com/user-attachments/assets/acdf9e98-93fe-415d-888f-6e772963aa51)
...
![task2-3](https://github.com/user-attachments/assets/0d8ae29d-545d-490d-82e2-7ad574e1d80a)
...
![task4](https://github.com/user-attachments/assets/185c35c9-92c2-4408-bf0d-b335aee6a811)
...
![task5](https://github.com/user-attachments/assets/dceefa57-7ef7-43b0-bf87-16239d125e33)

```bash
#!/bin/bash

# Задайте свои ФИО
FIO="Вахтанов Андрей Сергеевич"
...
if [ "$1" -eq 1 ]; then
    ...
    echo "Неверный аргумент. Используйте 1 для ФИО или 2 для текущей даты."
fi
```
