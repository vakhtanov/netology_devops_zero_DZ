 ...
 * компиляторы, которые прописаны в зависимостях пакета `build-essential`, так
что достаточно установить его со всеми зависимостями
 * autoconf и automake
 * файл configure, необходимый для процесса сборки (в случае его отсутствия
надо выполнить: ./bootstrap или ./autogen.sh)
