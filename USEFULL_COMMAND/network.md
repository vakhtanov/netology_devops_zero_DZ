...
* Jumbogram (передача до 4 ГБ данных в одном пакете)
        ...
        увеличенное адресное пространство, передача Jumbogram,
        автоконфигурация адресации
        2 IPv6 активно распространяется и рано или поздно полностью вытеснит IPv4
        3 В IPv6 отказались от широковещательных сообщений, но добавили
        новый тип трафика — anycast, к ближайшему узлу,
