...
Llibvirt позволяет управлять всеми аспектами вашей виртуализированной среды с помощью простого и мощного API.
...
Эта команда создаёт новую виртуальную машину из XML-файла конфигурации, который содержит параметры виртуализации.
