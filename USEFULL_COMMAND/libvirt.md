...
! Обратите внимание: Запуск виртуальных машин производится из-под пользователя НЕroot без ssh подключения , так как вам нужна GNU оболочка, иначе возникнет ошибка: Gtk-WARNING **: xx:xx:xx.xx: cannot open display:
