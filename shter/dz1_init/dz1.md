...
------
![01vesion](https://github.com/user-attachments/assets/1e836ed4-5e14-4721-99ee-5e7ae11c2a5a)
...
```
"result": "hNLzO7GE2y6SoPxa"
```
6. Раскомментируйте блок кода, примерно расположенный на строчках 29–42 файла **main.tf**.
Выполните команду ```terraform validate```. Объясните, в чём заключаются намеренно допущенные ошибки. Исправьте их.  
![02validate](https://github.com/user-attachments/assets/2ff33c73-0cf8-4bc9-97bc-9d90b607ffe5)
```
первая ошибка - у ресурса нет имени
вторая ошибка - имя ресурска не может начинаться с цифры
```
![03validate2](https://github.com/user-attachments/assets/0da81e5f-4111-4af2-bfd6-ad0c494441a2)
```
третья ошибка - ссылка на необъявленный ресурс - лишние символы в имени и ошибки в регистре
```
